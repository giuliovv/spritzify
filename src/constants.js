const bars = [
    ...
    ,
    {
        ...
        menu: [
            ...
            { id: 10, name: 'Caipiroska', price: 8, image: '/images/mojito_image.webp', category: 'Pestati' },
            { id: 11, name: 'Caipirinha', price: 8, image: '/images/mojito_image.webp', category: 'Pestati' },
            { id: 12, name: 'Mojito', price: 8, image: '/images/mojito_image.webp', category: 'Pestati' },
            { id: 13, name: 'Mixed Fruit Mojito', price: 8, image: '/images/mojito_image.webp', category: 'Pestati' },
            { id: 14, name: 'Stra-Corona', price: 6, image: '/images/margarita_image.webp', category: 'Le Nostre Specialità' },
            { id: 15, name: 'Sunsea', price: 8, image: '/images/spritz_campari_image.webp', category: 'Le Nostre Specialità' },
            { id: 16, name: 'Orgasmo', price: 8, image: '/images/margarita_image.webp', category: 'Le Nostre Specialità' },
            { id: 17, name: 'Barbie', price: 8, image: '/images/spritz_campari_image.webp', category: 'Le Nostre Specialità' },
            { id: 18, name: 'Bob Marley', price: 8, image: '/images/margarita_image.webp', category: 'Le Nostre Specialità' },
            { id: 19, name: 'Sexy Red', price: 8, image: '/images/spritz_campari_image.webp', category: 'Le Nostre Specialità' },
            { id: 20, name: 'The Megan', price: 8, image: '/images/margarita_image.webp', category: 'Le Nostre Specialità' },
            { id: 21, name: 'Spritz Aperol', price: 7, image: '/images/spritz_image.webp', category: 'Pre-Dinner e Aperitivi' },
            { id: 22, name: 'Spritz Campari', price: 7, image: '/images/spritz_campari_image.webp', category: 'Pre-Dinner e Aperitivi' },
            { id: 23, name: 'Hugo Spritz', price: 7, image: '/images/old_fashioned_image.webp', category: 'Pre-Dinner e Aperitivi' },
            { id: 24, name: 'Negroni', price: 8, image: '/images/spritz_image.webp', category: 'Pre-Dinner e Aperitivi' },
            { id: 25, name: 'Negroni Sbagliato', price: 7.5, image: '/images/spritz_campari_image.webp', category: 'Pre-Dinner e Aperitivi' },
            { id: 26, name: 'Americano', price: 7, image: '/images/old_fashioned_image.webp', category: 'Pre-Dinner e Aperitivi' },
            { id: 27, name: 'Love Mimosa', price: 8, image: '/images/spritz_image.webp', category: 'Pre-Dinner e Aperitivi' },
            { id: 28, name: 'Campari Soda e Prosecco', price: 6, image: '/images/spritz_campari_image.webp', category: 'Pre-Dinner e Aperitivi' },
            { id: 29, name: 'Sex on the Beach', price: 8, image: '/images/spritz_image.webp', category: 'Long Drinks' },
            { id: 30, name: 'Long Island', price: 8, image: '/images/margarita_image.webp', category: 'Long Drinks' },
            { id: 31, name: 'Wodka Lemon', price: 7, image: '/images/spritz_campari_image.webp', category: 'Long Drinks' },
            { id: 32, name: 'Wodka Redbull', price: 7, image: '/images/old_fashioned_image.webp', category: 'Long Drinks' },
            { id: 33, name: 'Coca Rum', price: 7, image: '/images/margarita_image.webp', category: 'Long Drinks' },
            { id: 34, name: 'Moscow Mule', price: 8, image: '/images/spritz_image.webp', category: 'Long Drinks' },
            { id: 35, name: 'Angelo Azzurro', price: 8, image: '/images/spritz_campari_image.webp', category: 'Long Drinks' },
            { id: 36, name: 'Quattro Bianchi (con sciroppo)', price: 8, image: '/images/old_fashioned_image.webp', category: 'Long Drinks' },
            { id: 37, name: 'Mojito Analcolico', price: 7, image: '/images/mojito_image.webp', category: 'Analcolici' },
            { id: 38, name: 'Analcolico alla Frutta #99', price: 7, image: '/images/mojito_image.webp', category: 'Analcolici' },
            { id: 39, name: 'Pestato Analcolico', price: 8, image: '/images/mojito_image.webp', category: 'Analcolici' },
            { id: 40, name: 'Tassoni', price: 3, image: '/images/bottle_image.webp', category: 'Analcolici' },
            { id: 41, name: 'Crodino', price: 3, image: '/images/bottle_image.webp', category: 'Analcolici' },
            { id: 42, name: 'Bitter Rosso', price: 3, image: '/images/bottle_image.webp', category: 'Analcolici' },
            { id: 43, name: 'Gin Lemon', price: 8, image: '/images/gintonic_image.webp', category: 'Gintoneria' },
            { id: 44, name: 'Coca Piccola', price: 2.6, image: '/images/bottle_image.webp', category: 'Analcolici' },
            { id: 45, name: 'Coca Media', price: 3.6, image: '/images/bottle_image.webp', category: 'Analcolici' },
            { id: 46, name: 'Birra Piccola', price: 3.5, image: '/images/beer_image.webp', category: 'Birra' },
            { id: 47, name: 'Birra Media', price: 5.5, image: '/images/beer_image.webp', category: 'Birra' },
            { id: 48, name: 'Menabrea', price: 5.5, image: '/images/beer_image.webp', category: 'Birra' },
            { id: 49, name: 'Ichnusa', price: 5.5, image: '/images/beer_image.webp', category: 'Birra' },
            { id: 50, name: 'Corona', price: 4, image: '/images/beer_image.webp', category: 'Birra' },
            { id: 51, name: 'Tonica', price: 3, image: '/images/bottle_image.webp', category: 'Analcolici' },
            { id: 52, name: 'Tonica Pompelmo', price: 3, image: '/images/bottle_image.webp', category: 'Analcolici' },
            { id: 56, name: 'Camparino', price: 3.5, image: '/images/camparino_image.webp', category: 'Pre-Dinner e Aperitivi' },
            { id: 57, name: 'Thè Pesca', price: 2.8, image: '/images/bottle_image.webp', category: 'Analcolici' },
            { id: 58, name: 'Thè Limone', price: 2.8, image: '/images/bottle_image.webp', category: 'Analcolici' },
            { id: 59, name: 'Thè Verde', price: 2.8, image: '/images/bottle_image.webp', category: 'Analcolici' },
            { id: 60, name: 'Frizzantino 1L', price: 11, image: '/images/bianco_image.webp', category: 'Vino' },
            { id: 61, name: 'Caraffa Gin Tonic', price: 21, image: '/images/bottle_image.webp', category: 'Caraffe' },
            { id: 62, name: 'Caraffa Spritz', price: 18, image: '/images/bottle_image.webp', category: 'Caraffe' },
            { id: 63, name: 'Coca', price: 2.6, image: '/images/can_image.webp', category: 'Analcolici' },
            { id: 64, name: 'Coca Zero', price: 2.6, image: '/images/can_image.webp', category: 'Analcolici' },
            { id: 65, name: 'Fanta', price: 2.6, image: '/images/can_image.webp', category: 'Analcolici' },
            { id: 66, name: 'Sprite', price: 2.6, image: '/images/can_image.webp', category: 'Analcolici' }
        ],
        menuSuggestions: [
            { category: 'Analcolici', startHour: 0, endHour: 11 },
