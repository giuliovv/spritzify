const bars = [
    ...
    ,
    {
        ...
        menu: [
            { id: 1, name: 'Gin Tonic o Lemon', price: 8, image: '/gintonic_image.webp', category: 'Gintoneria' },
            { id: 2, name: 'J.Rose', price: 12, image: '/gintonic_image.webp', category: 'Gintoneria' },
            { id: 3, name: 'Malfy', price: 10, image: '/gintonic_image.webp', category: 'Gintoneria' },
            { id: 4, name: 'Hendrick’s', price: 10, image: '/gintonic_image.webp', category: 'Gintoneria' },
            { id: 5, name: 'Gin Mare', price: 10, image: '/gintonic_image.webp', category: 'Gintoneria' },
            { id: 6, name: 'Alba87 Gin', price: 10, image: '/gintonic_image.webp', category: 'Gintoneria' },
            { id: 7, name: 'Amuerte', price: 12, image: '/gintonic_image.webp', category: 'Gintoneria' },
            { id: 8, name: 'Nordes', price: 10, image: '/gintonic_image.webp', category: 'Gintoneria' },
            { id: 9, name: 'Bulldog', price: 8, image: '/gintonic_image.webp', category: 'Gintoneria' },
            { id: 10, name: 'Falterona 1654', price: 8, image: '/gintonic_image.webp', category: 'Gintoneria' },
            { id: 11, name: 'Caipiroska', price: 8, image: '/mojito_image.webp', category: 'Pestati' },
            { id: 12, name: 'Caipirinha', price: 8, image: '/mojito_image.webp', category: 'Pestati' },
            { id: 13, name: 'Mojito', price: 8, image: '/mojito_image.webp', category: 'Pestati' },
            { id: 14, name: 'Mixed Fruit Mojito', price: 8, image: '/mojito_image.webp', category: 'Pestati' },
            { id: 15, name: 'Stra-Corona', price: 6, image: '/margarita_image.webp', category: 'Le Nostre Specialità' },
            { id: 16, name: 'Sunsea', price: 8, image: '/spritz_campari_image.webp', category: 'Le Nostre Specialità' },
            { id: 17, name: 'Orgasmo', price: 8, image: '/margarita_image.webp', category: 'Le Nostre Specialità' },
            { id: 18, name: 'Barbie', price: 8, image: '/spritz_campari_image.webp', category: 'Le Nostre Specialità' },
            { id: 19, name: 'Bob Marley', price: 8, image: '/margarita_image.webp', category: 'Le Nostre Specialità' },
            { id: 20, name: 'Sexy Red', price: 8, image: '/spritz_campari_image.webp', category: 'Le Nostre Specialità' },
            { id: 21, name: 'The Megan', price: 8, image: '/margarita_image.webp', category: 'Le Nostre Specialità' },
            { id: 22, name: 'Spritz Aperol', price: 7, image: '/spritz_image.webp', category: 'Pre-Dinner e Aperitivi' },
            { id: 23, name: 'Spritz Campari', price: 7, image: '/spritz_campari_image.webp', category: 'Pre-Dinner e Aperitivi' },
            { id: 24, name: 'Hugo Spritz', price: 7, image: '/old_fashioned_image.webp', category: 'Pre-Dinner e Aperitivi' },
            { id: 25, name: 'Negroni', price: 8, image: '/spritz_image.webp', category: 'Pre-Dinner e Aperitivi' },
            { id: 26, name: 'Negroni Sbagliato', price: 7.5, image: '/spritz_campari_image.webp', category: 'Pre-Dinner e Aperitivi' },
            { id: 27, name: 'Americano', price: 7, image: '/old_fashioned_image.webp', category: 'Pre-Dinner e Aperitivi' },
            { id: 28, name: 'Love Mimosa', price: 8, image: '/spritz_image.webp', category: 'Pre-Dinner e Aperitivi' },
            { id: 29, name: 'Campari Soda e Prosecco', price: 6, image: '/spritz_campari_image.webp', category: 'Pre-Dinner e Aperitivi' },
            { id: 30, name: 'Sex on the Beach', price: 8, image: '/spritz_image.webp', category: 'Long Drinks' },
            { id: 31, name: 'Long Island', price: 8, image: '/margarita_image.webp', category: 'Long Drinks' },
            { id: 32, name: 'Wodka Lemon', price: 7, image: '/spritz_campari_image.webp', category: 'Long Drinks' },
            { id: 33, name: 'Wodka Redbull', price: 7, image: '/old_fashioned_image.webp', category: 'Long Drinks' },
            { id: 34, name: 'Coca Rum', price: 7, image: '/margarita_image.webp', category: 'Long Drinks' },
            { id: 35, name: 'Moscow Mule', price: 8, image: '/spritz_image.webp', category: 'Long Drinks' },
            { id: 36, name: 'Angelo Azzurro', price: 8, image: '/spritz_campari_image.webp', category: 'Long Drinks' },
            { id: 37, name: 'Quattro Bianchi (con sciroppo)', price: 8, image: '/old_fashioned_image.webp', category: 'Long Drinks' },
            { id: 38, name: 'Mojito Analcolico', price: 7, image: '/mojito_image.webp', category: 'Analcolici' },
            { id: 39, name: 'Analcolico alla Frutta #99', price: 7, image: '/mojito_image.webp', category: 'Analcolici' },
            { id: 40, name: 'Pestato Analcolico', price: 8, image: '/mojito_image.webp', category: 'Analcolici' },
            { id: 41, name: 'Tassoni', price: 3, image: '/bottle_image.webp', category: 'Analcolici' },
            { id: 42, name: 'Crodino', price: 3, image: '/bottle_image.webp', category: 'Analcolici' },
            { id: 43, name: 'Bitter Rosso', price: 3, image: '/bottle_image.webp', category: 'Analcolici' }
        ]
    }
];
